...
[RequireComponent(typeof(ThrowHandsEnemyAggressiveFSM))]

public class ThrowHandsEnemyStunFSM : MonoBehaviour
{
    public enum States
    {
        INITIAL,
    ...
    private ThrowHandsEnemyAggressiveFSM enemyAgressiveFSM;
